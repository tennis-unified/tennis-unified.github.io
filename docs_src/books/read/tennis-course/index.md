---
title: "Tennis course"
description: "Tennis course. Curated from the Tennis Books library."
---
...
Tennis course. Curated from the Tennis Books library.
...
<iframe class="pdf-viewer" src="../../Tennis_course.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH" title="Tennis course">
  Your browser does not support inline PDF viewing. <a href="../../Tennis_course.pdf">Download the PDF</a> instead.
</iframe>

[Download the PDF ↗](../../Tennis_course.pdf) · [Open in new tab ↗](../../Tennis_course.pdf)
