...
description: "tennis tutorial. Curated from the Tennis Books library."
---
...
tennis tutorial. Curated from the Tennis Books library.
...
<iframe class="pdf-viewer" src="../../tennis_tutorial.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH" title="tennis tutorial">
  Your browser does not support inline PDF viewing. <a href="../../tennis_tutorial.pdf">Download the PDF</a> instead.
</iframe>

[Download the PDF ↗](../../tennis_tutorial.pdf) · [Open in new tab ↗](../../tennis_tutorial.pdf)
