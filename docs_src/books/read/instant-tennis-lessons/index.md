...
<iframe class="pdf-viewer" src="../../Instant_tennis_lessons.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH" title="Instant tennis lessons">
  Your browser does not support inline PDF viewing. <a href="../../Instant_tennis_lessons.pdf">Download the PDF</a> instead.
</iframe>

[Download the PDF ↗](../../Instant_tennis_lessons.pdf) · [Open in new tab ↗](../../Instant_tennis_lessons.pdf)
