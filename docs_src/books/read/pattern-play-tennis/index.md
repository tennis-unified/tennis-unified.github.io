...
<iframe class="pdf-viewer" src="../../Pattern_play_tennis.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH" title="Pattern play tennis">
  Your browser does not support inline PDF viewing. <a href="../../Pattern_play_tennis.pdf">Download the PDF</a> instead.
</iframe>

[Download the PDF ↗](../../Pattern_play_tennis.pdf) · [Open in new tab ↗](../../Pattern_play_tennis.pdf)
