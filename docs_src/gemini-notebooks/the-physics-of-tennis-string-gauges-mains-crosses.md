...
**Source Vaults:** `Tennis Books` (`b2646cc6-1dff-422a-b797-403cc7abb319`) · `Tennis Research Project` (`0f19ffe8-c458-4ab1-8159-14ebaf9d323c`)  
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    STRING GAUGE & DIFFERENTIAL TENSION TUNING               │
│                                                                             │
│ [Thinner Gauge String (17G / 1.20mm)] ──► [Deeper Felt Penetration & Bite]  │
│                                                          │                  │
│ [Differential Tension: Crosses 2kg Looser] ◄─────────────┘                  │
│          │ (Reduces Friction Resistance on Main Strings)                    │
│          ▼                                                                  │
│ [Main String Deflects 40% Further Sideways During Ball Impact]              │
│          │                                                                  │
│          ▼                                                                  │
│ ⚡ [Massive Snapback Pulse: +400 RPM Spin & Crisp Dwell-Time Pocketing]      │
└─────────────────────────────────────────────────────────────────────────────┘
```
