# Modern Two-Handed Backhand: Hip Braking, Kinetic Transfer & Non-Dominant Drive

**Author:** Henry Phạm Đức · Tennis Future Lab & Kinetic Biomechanics Research  
**Domain:** Modern Stroke Mechanics & Kinetic Chaining  
**Source Vaults:** `Tennis Backhand` (`0536ae95-0545-450e-b9aa-c3f1ad5f583b`) · `Tennis Fundamentals` (`b05f3704-2ce7-43c7-b4a8-fb7abd0b7ef8`)  
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                 MODERN TWO-HANDED BACKHAND FORCE TRANSMISSION               │
│                                                                             │
│  [Closed / Neutral Foot Plant] ──► [Lead Hip Internal Rotation]             │
│                                                   │                         │
│  [Non-Dominant Arm Acceleration] ◄── [Torso Uncoiling & Hip Braking]        │
│          │ (Eastern Forehand Push)                                          │
│          ▼                                                                  │
│  [Linear-to-Rotational Impact Zone] ──► [High Over-Shoulder Extension]      │
└─────────────────────────────────────────────────────────────────────────────┘
```
