# Acromioclavicular & Sternoclavicular Mechanics: Clavicular Vaulting (40°) in Serves
...
**Keywords:** `Acromioclavicular Joint (AC), Sternoclavicular Joint (SC), Clavicular Posterior Rotation (40°), Clavicular Vaulting, Serve Elevation`  
...
During Stage 4 (Cock to Elevation), the clavicle rotates 40° backward around its longitudinal axis to clear the acromion from the humeral head.
