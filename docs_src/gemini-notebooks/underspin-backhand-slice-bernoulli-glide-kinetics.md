# The Underspin Backhand Slice: Aerodynamic Bernoulli Lift, Low Skid Angles & Ashleigh Barty/Federer Mechanics
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    UNDERSPIN BACKHAND SLICE AERODYNAMICS                    │
│                                                                             │
│ [High Takeback (Shoulder Level)] ──► [High-to-Low Linear Carve Path]        │
│                                                   │                         │
│ [Contact at 45° Frame Tilt] ◄─────────────────────┘                         │
│          │ (Negative Magnus Force Creates Upward Aerodynamic Float)         │
│          ▼                                                                  │
│ [Ball Glides Low Over Net Cord] ──► ⚡ [Razor-Low Hard-Court Skid (< 25cm)]  │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
```
                      ...
                      ══════════════════════════════════
                         ─────────────►
                       ╭───────────────╮
             Backspin  │       ▲       │  ──► UPWARD LIFT FORCE (F_L)
             Rotation  │   ◄───●───►   │
               (⟳)     │       ▼       │
                       ╰───────────────╯
                         ─────────────►
...
2. DROP & CARVE: Racket accelerates downward at a 30° angle, strings open 15°–20°
