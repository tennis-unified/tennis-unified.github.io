...
base = os.path.abspath("D:/Github Repos/tennis-unified")

# Load article metadata
with open(os.path.join(base, "articles_metadata.json"), "r", encoding="utf-8") as f:
    articles_data = json.load(f)

# Load all content files using absolute paths
content_files = {}
content_dir = os.path.join(base, "article_content")
...
# Read reference page
ref_path = os.path.join(base, "en/articles/EN-tenniskb-kinetic-chain-efficiency-and-energy-leak-audits/index.html")
...
for i, article_meta in enumerate(articles_data):
    ...
    slug = article_meta["slug"]
    out_dir = os.path.join(base, "en/articles", slug)
