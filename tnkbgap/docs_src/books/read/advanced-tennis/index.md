...
description: "Advanced tennis. Curated from the Tennis Books library."
---
...
Advanced tennis. Curated from the Tennis Books library.
...
<iframe class="pdf-viewer" src="../../Advanced_tennis.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH" title="Advanced tennis">
  Your browser does not support inline PDF viewing. <a href="../../Advanced_tennis.pdf">Download the PDF</a> instead.
</iframe>

[Download the PDF ↗](../../Advanced_tennis.pdf) · [Open in new tab ↗](../../Advanced_tennis.pdf)
