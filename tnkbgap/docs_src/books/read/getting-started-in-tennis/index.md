...
<iframe class="pdf-viewer" src="../../Getting_started_in_tennis.pdf#toolbar=1&navpanes=1&scrollbar=1&view=FitH" title="Getting started in tennis">
  Your browser does not support inline PDF viewing. <a href="../../Getting_started_in_tennis.pdf">Download the PDF</a> instead.
</iframe>

[Download the PDF ↗](../../Getting_started_in_tennis.pdf) · [Open in new tab ↗](../../Getting_started_in_tennis.pdf)
