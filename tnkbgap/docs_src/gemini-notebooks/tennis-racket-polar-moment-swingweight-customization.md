# Racket Dynamics & Swingweight Physics: Polar Moments of Inertia, Recoil Weights & Lead-Tape Tuning
...
**Source Vaults:** `Tennis Books` (`b2646cc6-1dff-422a-b797-403cc7abb319`) · `Tennis Fundamentals` (`b05f3704-2ce7-43c7-b4a8-fb7abd0b7ef8`)  
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    RACKET ROTATIONAL INERTIA & CUSTOMIZATION                │
│                                                                             │
│ [Static Mass (M)] ──► [Balance Point (BP)] ──► [Swingweight (I_xx @ 10cm)]  │
│                                                       │                     │
│ [Polar Twist Stability (I_zz @ 3/9 o'clock)] ◄────────┘                     │
│          │                                                                  │
│          ▼                                                                  │
│ [Center of Percussion (COP)] ──► ⚡ [Zero Shock Transmission to Wrist/Elbow] │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
```
                        12 o'clock (Maximum Swingweight / Power)
                                    ╭─────╮
                                    │     │
       3 o'clock (Torsional Twist)  │  +  │  9 o'clock (Torsional Twist)
                                    │     │
                                    ╰─────╯
                                       │
                                       │ (Shaft)
...
```
        Ball Impacts COP ════════════════════════════════════► Net Transverse Force at Hand = 0
        Ball Impacts High in Head (Above COP) ──────────────► Handle Kicks Forward
        Ball Impacts Low in Throat (Below COP) ──────────────► Handle Kicks Backward
```
...
$$q = \frac{I_{\text{pivot}}}{M \cdot d_{\text{pivot-to-cm}}}$$
