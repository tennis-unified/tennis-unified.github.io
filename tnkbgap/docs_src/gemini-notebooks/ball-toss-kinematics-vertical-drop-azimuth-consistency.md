# Ball Toss Kinematics: 12:00 vs 1:00 Azimuth, Sub-2cm Dispersion & Gravity Drop Release
...
**Keywords:** `Ball Toss Kinematics, Toss Azimuth (12:00 vs 1:00), Sub-2cm Dispersion, Gravity Drop Release, Shoulder Elevation`  
...
## 1. The Glenohumeral Shoulder Hinge Law

Eliminating wrist flick and elbow bend ensures the ball travels on a perfectly repeatable vertical trajectory.
...
## 3. Toss Invariance Calibration Drills

Toss-and-catch with racket on ground; laser ring toss tracking; 50 consecutive invariant toss repetitions.
