...
**Source Vaults:** `HIIT (Laursen & Buchheit, 2019)` (`books/read/hiit-laursen-buchheit`) · `Tennis Research Project` (`0f19ffe8-c458-4ab1-8159-14ebaf9d323c`)  
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    BIOENERGETIC CONTINUUM DURING TENNIS PLAY                │
│                                                                             │
│ [Point Begins: 0–10s] ──► [ATP-CP Phosphagen System Drives Explosive Bursts]│
│                                           │                                 │
│ [Point Ends: 15–20s Rest] ◄───────────────┘                                 │
│          │ (Aerobic Mitochondrial Resynthesis of Phosphocreatine)           │
│          ▼                                                                  │
│ [High-Lactate Spikes (Long Rally)] ──► [Lactate Shuttle to Heart & Slow-Twitch]│
│          │ (MCT-1 Transporters Clear H+ Ions to Prevent Muscle Fatigue)     │
│          ▼                                                                  │
│ ⚡ [100% Neuromuscular Power Restored for Next Point]                        │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
During an intense 8-shot rally involving maximal lateral sprints:
- Intracellular PCr stores drop by **50% to 70%**.
- In the subsequent 20-second recovery, the aerobic system consumes oxygen at an accelerated rate (Excess Post-Exercise Oxygen Consumption — EPOC) to resynthesize PCr:
