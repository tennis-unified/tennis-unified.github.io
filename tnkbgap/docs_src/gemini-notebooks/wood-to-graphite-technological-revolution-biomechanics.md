# The Wood-to-Graphite Technological Revolution: How Head Size (65 to 100 sq in) Rewrote Tennis Biomechanics
...
**Source Vaults:** `Tennis Books` (`b2646cc6-1dff-422a-b797-403cc7abb319`) · `Open Era Tennis History` (`history/open-era-timeline`)  
**Keywords:** `Wood to Graphite`, `Howard Head (Prince Classic)`, `Head Size Evolution (65 to 100 sq in)`, `Torsional Stability`, `Open Stance Revolution`, `Björn Borg`, `Ivan Lendl`
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    THE 50-YEAR RACKET EVOLUTION TIMELINE                    │
│                                                                             │
│ [WOOD ERA (1874–1980): 65 sq in / 400g] ──► [Closed Stance / Linear Push]   │
│                         │                                                   │
│                         ▼                                                   │
│ [GRAPHITE MIDSIZE (1980–1995): 85 sq in (Pro Staff)] ──► [Semi-Open Stance] │
│                         │                                                   │
│                         ▼                                                   │
│ [OVERSIZE / MODERN (1995–Present): 98–100 sq in] ──► [Full Rotational Whip] │
│                         │                                                   │
│ ⚡ [Co-Polymer Strings + 100 sq in = 4,000 RPM Rotational Open Stance] ◄────┘ │
└─────────────────────────────────────────────────────────────────────────────┘
```
