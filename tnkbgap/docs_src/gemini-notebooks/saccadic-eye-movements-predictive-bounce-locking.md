# Predictive Saccades: Eye Jump Dynamics (600°/s) Pre-Locking the Ball Bounce Zone 150ms Early
...
**Source Vaults:** `Neuro-Ocular Studies · Modern Stroke Consensus`  
**Keywords:** `Predictive Saccades, Eye Jump Velocity (600°/s), Ball Bounce Locking, Superior Colliculus, Saccadic Suppression`  
...
## 2. Superior Colliculus Saccadic Trigger

The midbrain superior colliculus executes a ballistic 30ms saccade, landing the fovea on the court surface 150ms before the ball bounces.

---

## 3. Predictive Saccade Training Drills

Visual target bounce cones; calling out bounce coordinates before the ball lands; strobe bounce tracking.
