# Match-Day Performance Nutrition: Glycogen Supercompensation, Intra-Match Fueling & Electrolytes
...
**Source Vaults:** `Tennis Research Project` (`0f19ffe8-c458-4ab1-8159-14ebaf9d323c`) · `Tennis Books` (`b2646cc6-1dff-422a-b797-403cc7abb319`)  
**Keywords:** `Tennis Nutrition`, `Glycogen Supercompensation`, `Intra-Match Fueling`, `Dual-Source Carbohydrates (2:1 Glucose-to-Fructose)`, `Sodium Bicarbonate Buffering`, `Novak Djokovic Diet`
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    MATCH-DAY BIO-FUELING & GLYCOGEN TIMELINE                │
│                                                                             │
│ [24h Prior: Glycogen Loading (8g/kg)] ──► [Liver/Muscle Glycogen Maxed]     │
│                                                          │                  │
│ [3h Pre-Match: Low-GI Carbohydrates + Lean Protein] ◄────┘                  │
│                         │                                                   │
│                         ▼                                                   │
│ [During Match: 60g/hour 2:1 Glucose-to-Fructose Dual-Transporter Solution]  │
│                         │ (Bypasses SGLT-1 Saturation Bottleneck)           │
│                         ▼                                                   │
│ ⚡ [Zero Glycogen Depletion Choke in 5th Hour of Play — Full Power Maintained]│
└─────────────────────────────────────────────────────────────────────────────┘
```

---

## 1. Pre-Match Glycogen Supercompensation

```
TARGET CARBOHYDRATE INTAKE:
  Day Before Match: 7–9 g / kg Bodyweight (e.g., 560g CHO for 75kg Athlete)
  Focus: Low-fiber, complex starches (White Jasmine Rice, Sweet Potatoes, Oats)
```
...
## 2. Dual-Source Intra-Match Fueling (60–90g/hr)

```
SINGLE GLUCOSE CARBOHYDRATE (Saturates at 60g/hr):
  Intestinal SGLT-1 Transporters Max Out ──► Bloating + Unabsorbed Sugar in Gut

DUAL-SOURCE GLUCOSE + FRUCTOSE (2:1 Ratio):
  SGLT-1 Transports Glucose (60g/hr) + GLUT-5 Transports Fructose (30g/hr)
  ──► 90g/hour Total Exogenous Oxidation Rate (+50% Fuel Delivery to Muscles)
```
...
## 3. Post-Match Anabolic Recovery Window (The 30-Minute Protocol)
