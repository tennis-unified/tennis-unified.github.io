...
article_number: 163
prev_article: "VI-tenniskb-tennis-elbow-eccentric-wrist-extensor-protocols"
...
Tỷ lệ làm việc trên nghỉ quyết định hệ năng lượng nào được huấn luyện, chứ không chỉ thời lượng làm việc. Tỷ lệ 1:3 phục hồi khoảng 70-80% phosphocreatine và huấn luyện công suất yếm khí alactic, trong khi tỷ lệ 1:5 phục hồi trên 90% và huấn luyện chính quá trình phục hồi. Chọn giữa hai tỷ lệ là quyết định về **nửa nào của điểm bóng mà vận động viên cần cải thiện**.
...
Bài viết này thiết lập **khung tối ưu tỷ lệ làm việc trên nghỉ chuyển hóa hoàn chỉnh**:

1. **Động Học Hệ Phosphagen & Việc Chọn Tỷ Lệ** - Tái tổng hợp phosphocreatine tuân theo một đường cong hai thành phần mũ với thành phần nhanh phục hồi khoảng 70% trong 30 giây và thành phần chậm cần 3-5 phút để phục hồi gần hoàn toàn.
2. **Đóng Góp Ưa Khí Ở Mỗi Tỷ Lệ** - Ở tỷ lệ 1:3, hệ ưa khí đóng góp 25-35% đầu ra công việc; ở tỷ lệ 1:5 tỷ lệ đó tăng lên 40-50%.
...
- Thứ nhất, chuyển **tối ưu tỷ lệ làm việc trên nghỉ chuyển hóa** từ một hành vi dựa trên trực giác và cảm xúc thành một **phác đồ lặp lại được**, với đầu vào được tuyên bố, đầu ra đo lường được, và kiểu thất bại được định nghĩa.
- Thứ hai, làm cho **các yếu tố giới hạn trở nên tường minh**. Những biến thực sự giới hạn hiệu suất ở đây là Phosphocreatine phục hồi ở tỷ lệ 1:3, Phosphocreatine phục hồi ở tỷ lệ 1:5 và Nhịp tim cuối khoảng làm việc; mọi thứ khác chỉ là thứ yếu cho tới khi ba biến này được kiểm soát.
...
### 2.1 Động Học Hệ Phosphagen & Việc Chọn Tỷ Lệ
...
- **Phosphocreatine phục hồi ở tỷ lệ 1:3** đo ở mức **70-80%** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Phosphocreatine phục hồi ở tỷ lệ 1:5** đo ở mức **90-96%** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Nhịp tim cuối khoảng làm việc** đo ở mức **85-92% maximum** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
...
### 2.2 Đóng Góp Ưa Khí Ở Mỗi Tỷ Lệ
...
- Dải mục tiêu cho **Phosphocreatine phục hồi ở tỷ lệ 1:3**: 70-80% trong điều kiện kiểm soát, suy giảm một mức đo được khi mệt.
- Dải mục tiêu cho **Phosphocreatine phục hồi ở tỷ lệ 1:5**: 90-96%, kiểm chứng ít nhất hai lần mỗi trung chu kỳ.
- Dải mục tiêu cho **Nhịp tim cuối khoảng làm việc**: 85-92% maximum, theo dõi bằng cùng một phác đồ mỗi lần.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ MÔ HÌNH ĐỊNH LƯỢNG - TỐI ƯU TỶ LỆ LÀM VIỆC TRÊN NGHỈ CHUYỂN HÓA        │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ 1. Phosphocreatine phục hồi ở tỷ lệ 1:3 = 70-80% (đầu vào kiểm soát │
│ │  được chính)                                                         │
│ ├─ 2. Phosphocreatine phục hồi ở tỷ lệ 1:5 = 90-96% (biến chuyển giao  │
│ │  thứ cấp)                                                            │
│ ├─ 3. Nhịp tim cuối khoảng làm việc = 85-92% maximum (dấu hiệu kiểm    │
│ │  chứng)                                                              │
...
1. **Khớp Tỷ Lệ Với Mục Tiêu Thích Nghi** - Tuyên bố mục tiêu trước buổi tập: công suất alactic dùng 1:3, năng lực phục hồi dùng 1:5; buổi tập không có tỷ lệ tuyên bố sẽ trôi về phía thoải mái.
2. **Giới Hạn Mức Suy Giảm Chất Lượng Khoảng Làm Việc** - Kết thúc bất kỳ loạt nào khi đầu ra giảm hơn 8-10% so với khoảng đầu tiên; vượt ngưỡng đó buổi tập huấn luyện khả năng chịu mệt thay vì phẩm chất mục tiêu.
...
| --- | --- | --- | --- |
| Phosphocreatine phục hồi ở tỷ lệ 1:3 | Đo trực tiếp, cùng phác đồ mỗi lần | 70-80% | 70-80% duy trì được khi mệt |
| Phosphocreatine phục hồi ở tỷ lệ 1:5 | Đo trực tiếp, cùng phác đồ mỗi lần | 90-96% | 90-96% duy trì được khi mệt |
| Nhịp tim cuối khoảng làm việc | Đo trực tiếp, cùng phác đồ mỗi lần | 85-92% maximum | 85-92% maximum duy trì được khi mệt |
...
Thứ tự ưu tiên khắc phục: trước hết đưa **Phosphocreatine phục hồi ở tỷ lệ 1:3** về dải mục tiêu, sau đó kiểm chứng lại **Phosphocreatine phục hồi ở tỷ lệ 1:5**; chỉ khi đó mới tăng tải. Cố sửa lỗi thực thi trong khi năng lực nền còn ngoài dải sẽ tạo ra những chỉnh sửa tạm thời và sụp đổ dưới áp lực thi đấu.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ ĐIỂM VÀO CHẨN ĐOÁN - TỐI ƯU TỶ LỆ LÀM VIỆC TRÊN NGHỈ CHUYỂN HÓA        │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ ĐẦU VÀO A: Phosphocreatine phục hồi ở tỷ lệ 1:3 = 70-80%            │
│ ├─ ĐẦU VÀO B: Phosphocreatine phục hồi ở tỷ lệ 1:5 = 90-96%            │
│ ├─ ĐẦU VÀO C: Nhịp tim cuối khoảng làm việc = 85-92% maximum           │
└────────────────────────────────────────────────────────────────────────┘

                    |
        ┌───────────┴────────────┐
        │ Phosphocreatine phục hồi │
        └───┬────────────────┬───┘
       CÓ   │                │  KHÔNG
   ┌────────▼────────┐  ┌────▼─────────────┐
   │ tăng tải        │  │ giữ tải,         │
...
Hãy quan sát riêng khoảnh khắc **Phosphocreatine phục hồi ở tỷ lệ 1:3** lệch khỏi mức 70-80% - trong gần như mọi trường hợp, độ lệch xuất hiện trước khiếm khuyết kỹ thuật nhìn thấy được, chứ không phải sau đó.
...
- **Bài viết 164 - Tải Hậu Chuỗi Và Tích Hợp Trung Tâm Truyền Lực**: đưa ra logic cửa sổ phục hồi quyết định khoảng cách giữa các khối tập này.
- **Bài viết 162 - Phục Hồi Viêm Gân Khuỷu Tay Tennis Elbow**: định nghĩa dấu hiệu lực - thời gian mà mẫu này cuối cùng phụ thuộc vào.
...
- **Bài viết 161 - Chu Kỳ Hóa Thể Lực & Luyện Tập Bio-Agentic**: chi tiết quy tắc tăng tiến tải giúp thích nghi này không bị đình trệ.
...
| --- | --- | --- | --- | --- |
| A - Chính | Loạt Alactic 1:3 | 4 x 8 | 6 x 20 giây chạy nước rút trên sân với 60 giây phục hồi, theo dõi mức suy giảm đầu ra | 60 giây |
| B - Phụ | Loạt Phục Hồi 1:5 | 3 x 10 | 6 x 20 giây với 100 giây phục hồi, theo dõi mức hồi nhịp tim | 60 giây |
...
Quy tắc cấp buổi tập: không bao giờ kết thúc buổi tập khi **Phosphocreatine phục hồi ở tỷ lệ 1:3** nằm ngoài dải mục tiêu quá một bước tăng tiến; mẫu bạn lặp lại khi đang ngoài dải chính là mẫu bạn sẽ tái hiện dưới áp lực.
