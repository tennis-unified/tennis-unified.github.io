---
title: "Bài viết 186: Phác Đồ Xả Chất Thải Chuyển Hóa Sau Trận"
description: "TennisKB - Bài viết 186: Phác Đồ Xả Chất Thải Chuyển Hóa Sau Trận | Tennis Future Lab"
author: "Henry Pham"
date: 2025-01-15
lang: vi
pillar: "the-luc"
...
article_number: 186
prev_article: "VI-tenniskb-pre-match-dynamic-mobility-priming-routines"
next_article: "VI-tenniskb-vo2-max-and-anaerobic-threshold-training-ratios"
---

# Bài viết 186: Phác Đồ Xả Chất Thải Chuyển Hóa Sau Trận

> **CUE CHUYÊN GIA:** **phác đồ xả chất thải chuyển hóa sau trận** = một **hợp đồng liều - đáp ứng** với phục hồi ở mẫu số - hãy huấn luyện đúng phẩm chất mà trận đấu thực sự đòi hỏi, ở mức tải mà mô có thể hấp thụ, và kiểm chứng bằng chỉ số thay vì bằng cảm giác.
...
<div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 8px; margin: 1.5rem 0;">
  <iframe src="https://www.youtube-nocookie.com/embed/VIDEO_ID_PLACEHOLDER" title="Phác Đồ Xả Chất Thải Chuyển Hóa Sau Trận" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
</div>

## 1. Tóm Tắt Điều Hành & Ý Đồ Thể Thao

Xả chất thải sau trận kết hợp **vận động cường độ thấp, bù nước và định thời dinh dưỡng** để tăng tốc trở về mức nền. Cửa sổ rất ngắn: 60-90 phút đầu quyết định buổi tập kế tiếp có thể hiệu quả nhanh tới đâu, và phục hồi thụ động trong cửa sổ đó có một chi phí đo được.
...
Bài viết này thiết lập **khung phác đồ xả chất thải chuyển hóa sau trận hoàn chỉnh**:

1. **Cửa sổ sau vận động** - Tái tổng hợp glycogen, tổng hợp protein cơ và phục hồi thể tích huyết tương đều diễn ra nhanh nhất trong 60-90 phút đầu.
2. **Thành Phần Của Phác Đồ Xả** - Phác đồ kết hợp 10-15 phút vận động ở mức nói chuyện được, bù dịch ở 125-150% lượng mất đo được kèm natri, 0,3 g protein mỗi kilôgam, và 1,0-1,2 g carbohydrate mỗi kilôgam cho các buổi trên 90 phút.
3. **Nhu Cầu Hệ Năng Lượng Của Trận Đấu** - Một trận tennis thi đấu là dạng lai yếm khí alactic - ưa khí: phần lớn các điểm kéo dài dưới 10 giây và được ngăn cách bởi 20-25 giây phục hồi, nên hệ phosphagen cung cấp phần công việc quyết định trong khi hệ ưa khí chi phối tốc độ tái tổng hợp hệ đó giữa các điểm và giữa các game.
4. **Thích Nghi Thần Kinh Cơ & Gân** - Gân và mô liên kết thích nghi chậm hơn cơ, và đây là lý do cấu trúc khiến việc tăng tải nhanh tạo ra bệnh lý gân trước khi tạo ra hiệu suất.
...
- Thứ nhất, chuyển **phác đồ xả chất thải chuyển hóa sau trận** từ một hành vi dựa trên trực giác và cảm xúc thành một **phác đồ lặp lại được**, với đầu vào được tuyên bố, đầu ra đo lường được, và kiểu thất bại được định nghĩa.
- Thứ hai, làm cho **các yếu tố giới hạn trở nên tường minh**. Những biến thực sự giới hạn hiệu suất ở đây là Thời lượng vận động xả, Mục tiêu bù dịch và Liều protein; mọi thứ khác chỉ là thứ yếu cho tới khi ba biến này được kiểm soát.
...
- **Thời lượng vận động xả** đo ở mức **10-15 min** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Mục tiêu bù dịch** đo ở mức **125-150% of loss** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Liều protein** đo ở mức **0.3 g/kg** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
...
- Dải mục tiêu cho **Thời lượng vận động xả**: 10-15 min trong điều kiện kiểm soát, suy giảm một mức đo được khi mệt.
- Dải mục tiêu cho **Mục tiêu bù dịch**: 125-150% of loss, kiểm chứng ít nhất hai lần mỗi trung chu kỳ.
- Dải mục tiêu cho **Liều protein**: 0.3 g/kg, theo dõi bằng cùng một phác đồ mỗi lần.

### 2.3 Nhu Cầu Hệ Năng Lượng Của Trận Đấu
...
### 2.4 Thích Nghi Thần Kinh Cơ & Gân
...
### 2.5 Phục Hồi Tự Chủ & Các Dấu Hiệu Theo Dõi
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ MÔ HÌNH ĐỊNH LƯỢNG - PHÁC ĐỒ XẢ CHẤT THẢI CHUYỂN HÓA SAU TRẬN          │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ 1. Thời lượng vận động xả = 10-15 min (đầu vào kiểm soát được chính) │
│ ├─ 2. Mục tiêu bù dịch = 125-150% of loss (biến chuyển giao thứ cấp)   │
│ ├─ 3. Liều protein = 0.3 g/kg (dấu hiệu kiểm chứng)                    │
...
1. **Vận Động Trước, Uống Sau** - Bắt đầu vận động cường độ thấp trước khi nạp dịch; vận động phục hồi tuần hoàn và cải thiện hấp thụ.
2. **Bù 125-150% Lượng Dịch Đã Mất** - Bù nhiều hơn lượng đã mất vì quá trình bài tiết nước tiểu vẫn tiếp diễn; bao gồm natri để giữ thể tích.
...
| --- | --- | --- | --- |
| Thời lượng vận động xả | Đo trực tiếp, cùng phác đồ mỗi lần | 10-15 min | 10-15 min duy trì được khi mệt |
| Mục tiêu bù dịch | Đo trực tiếp, cùng phác đồ mỗi lần | 125-150% of loss | 125-150% of loss duy trì được khi mệt |
| Liều protein | Đo trực tiếp, cùng phác đồ mỗi lần | 0.3 g/kg | 0.3 g/kg duy trì được khi mệt |
...
Thứ tự ưu tiên khắc phục: trước hết đưa **Thời lượng vận động xả** về dải mục tiêu, sau đó kiểm chứng lại **Mục tiêu bù dịch**; chỉ khi đó mới tăng tải. Cố sửa lỗi thực thi trong khi năng lực nền còn ngoài dải sẽ tạo ra những chỉnh sửa tạm thời và sụp đổ dưới áp lực thi đấu.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ ĐIỂM VÀO CHẨN ĐOÁN - PHÁC ĐỒ XẢ CHẤT THẢI CHUYỂN HÓA SAU TRẬN          │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ ĐẦU VÀO A: Thời lượng vận động xả = 10-15 min                       │
│ ├─ ĐẦU VÀO B: Mục tiêu bù dịch = 125-150% of loss                      │
│ ├─ ĐẦU VÀO C: Liều protein = 0.3 g/kg                                  │
└────────────────────────────────────────────────────────────────────────┘

                    |
        ┌───────────┴────────────┐
        │ Thời lượng vận động xả   │
        └───┬────────────────┬───┘
       CÓ   │                │  KHÔNG
   ┌────────▼────────┐  ┌────▼─────────────┐
   │ tăng tải        │  │ giữ tải,         │
...
Hãy quan sát riêng khoảnh khắc **Thời lượng vận động xả** lệch khỏi mức 10-15 min - trong gần như mọi trường hợp, độ lệch xuất hiện trước khiếm khuyết kỹ thuật nhìn thấy được, chứ không phải sau đó.
...
- **Bài viết 187 - Tỷ Lệ Huấn Luyện VO2 Max Và Ngưỡng Thiếu Oxy**: ghi nhận kiểu thất bại thường bị nhầm với lỗi kỹ thuật ở đây.
- **Bài viết 185 - Chuẩn Bị Động Tính Trước Trận**: đưa ra logic cửa sổ phục hồi quyết định khoảng cách giữa các khối tập này.
- **Bài viết 188 - Kiểm Toán Thiếu Hụt Năng Lượng Động Học VĐV Chấn Thương**: định nghĩa dấu hiệu lực - thời gian mà mẫu này cuối cùng phụ thuộc vào.
- **Bài viết 184 - Thở Điaphragm Và Phác Đồ Khôi Phục Phản Xạ Phụ**: trình bày tín hiệu tri giác giúp rút ngắn độ trễ nhận diện trong tình huống này.
...
- **Bài viết 181 - Patellar Tendonitis Prevention in High Acceleration/Braking**: cung cấp phác đồ đo lường dùng để kiểm chứng các mục tiêu ở Mục 4.
...
Đọc cùng các bài này, phác đồ xả chất thải chuyển hóa sau trận trở thành một **nút trong hệ thống** thay vì một bài tập tách rời: ràng buộc cơ sinh học, tín hiệu tri giác, quy tắc tải và giá trị theo trạng thái tỷ số đều phải đúng đồng thời thì mẫu mới tồn tại được dưới áp lực thi đấu.
...
| --- | --- | --- | --- | --- |
| A - Chính | Xả Sau Trận | 4 x 8 | 12 phút vận động nhẹ, rồi nạp dịch và protein trong vòng 60 phút | 60 giây |
| B - Phụ | Nhật Ký Bù Nước | 3 x 10 | Theo dõi khối lượng cơ thể trước và sau và bù 125-150% | 60 giây |
...
Quy tắc cấp buổi tập: không bao giờ kết thúc buổi tập khi **Thời lượng vận động xả** nằm ngoài dải mục tiêu quá một bước tăng tiến; mẫu bạn lặp lại khi đang ngoài dải chính là mẫu bạn sẽ tái hiện dưới áp lực.
