---
title: "Bài viết 171: Eccentric Deceleration Strength for Multi-Directional Footwork"
description: "TennisKB - Bài viết 171: Eccentric Deceleration Strength for Multi-Directional Footwork | Tennis Future Lab"
author: "Henry Pham"
date: 2025-01-15
lang: vi
pillar: "the-luc"
...
article_number: 171
prev_article: "VI-tenniskb-hydration-electrolyte-ratios-and-core-temp-regulation"
next_article: "VI-tenniskb-rotator-cuff-thermal-warm-up-scapular-y-t-w-protocols"
---

# Bài viết 171: Eccentric Deceleration Strength for Multi-Directional Footwork

> **CUE CHUYÊN GIA:** **sức mạnh hãm lệch tâm cho bộ pháp đa hướng** = một **hợp đồng liều - đáp ứng** với phục hồi ở mẫu số - hãy huấn luyện đúng phẩm chất mà trận đấu thực sự đòi hỏi, ở mức tải mà mô có thể hấp thụ, và kiểm chứng bằng chỉ số thay vì bằng cảm giác.
...
Giảm tốc là **kỹ năng giới hạn của di chuyển tennis**: khả năng hấp thụ 3-4 lần khối lượng cơ thể ở bàn chân trụ quyết định tốc độ bắt đầu lần tăng tốc kế tiếp. Do đó sức mạnh lệch tâm không phải một phẩm chất bổ trợ mà là yếu tố quyết định trực tiếp thời gian đổi hướng.
...
Bài viết này thiết lập **khung sức mạnh hãm lệch tâm cho bộ pháp đa hướng hoàn chỉnh**:

1. **Cơ Học Của Pha Hãm** - Việc hãm bắt đầu từ bước áp chót, bước này phải ngắn lại để hạ khối tâm và đặt bàn chân trước hông.
2. **Tiến Triển Tải Lệch Tâm** - Năng lực lệch tâm được xây bằng các bài tiếp đất có kiểm soát, rồi các mẫu đặt chân ngang và giữ vững, rồi các bài phản ứng với tín hiệu bên ngoài.
...
- Thứ nhất, chuyển **sức mạnh hãm lệch tâm cho bộ pháp đa hướng** từ một hành vi dựa trên trực giác và cảm xúc thành một **phác đồ lặp lại được**, với đầu vào được tuyên bố, đầu ra đo lường được, và kiểu thất bại được định nghĩa.
- Thứ hai, làm cho **các yếu tố giới hạn trở nên tường minh**. Những biến thực sự giới hạn hiệu suất ở đây là Lực hãm tại bàn chân trụ, Độ dài bước áp chót và Thời gian đổi hướng; mọi thứ khác chỉ là thứ yếu cho tới khi ba biến này được kiểm soát.
...
- **Lực hãm tại bàn chân trụ** đo ở mức **3-4 x body mass** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Độ dài bước áp chót** đo ở mức **60-75% of maximal stride** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Thời gian đổi hướng** đo ở mức **2.30-2.55 s for 5-10-5** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
...
- Dải mục tiêu cho **Lực hãm tại bàn chân trụ**: 3-4 x body mass trong điều kiện kiểm soát, suy giảm một mức đo được khi mệt.
- Dải mục tiêu cho **Độ dài bước áp chót**: 60-75% of maximal stride, kiểm chứng ít nhất hai lần mỗi trung chu kỳ.
- Dải mục tiêu cho **Thời gian đổi hướng**: 2.30-2.55 s for 5-10-5, theo dõi bằng cùng một phác đồ mỗi lần.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ MÔ HÌNH ĐỊNH LƯỢNG - SỨC MẠNH HÃM LỆCH TÂM CHO BỘ PHÁP ĐA HƯỚNG        │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ 1. Lực hãm tại bàn chân trụ = 3-4 x body mass (đầu vào kiểm soát    │
│ │  được chính)                                                         │
│ ├─ 2. Độ dài bước áp chót = 60-75% of maximal stride (biến chuyển giao │
│ │  thứ cấp)                                                            │
│ ├─ 3. Thời gian đổi hướng = 2.30-2.55 s for 5-10-5 (dấu hiệu kiểm      │
│ │  chứng)                                                              │
...
1. **Thành Thạo Tiếp Đất Có Kiểm Soát Trước** - Hai tuần tiếp đất có kiểm soát trước bất kỳ bài hãm phản ứng nào; trình tự này không được bỏ qua.
2. **Ra Tín Hiệu Rõ Cho Bước Áp Chót** - Dùng tín hiệu bên ngoài là rút ngắn bước trước khi đặt chân; các tín hiệu bên trong về kích hoạt cơ làm suy giảm chất lượng vận động.
...
| --- | --- | --- | --- |
| Lực hãm tại bàn chân trụ | Đo trực tiếp, cùng phác đồ mỗi lần | 3-4 x body mass | 3-4 x body mass duy trì được khi mệt |
| Độ dài bước áp chót | Đo trực tiếp, cùng phác đồ mỗi lần | 60-75% of maximal stride | 60-75% of maximal stride duy trì được khi mệt |
| Thời gian đổi hướng | Đo trực tiếp, cùng phác đồ mỗi lần | 2.30-2.55 s for 5-10-5 | 2.30-2.55 s for 5-10-5 duy trì được khi mệt |
...
Thứ tự ưu tiên khắc phục: trước hết đưa **Lực hãm tại bàn chân trụ** về dải mục tiêu, sau đó kiểm chứng lại **Độ dài bước áp chót**; chỉ khi đó mới tăng tải. Cố sửa lỗi thực thi trong khi năng lực nền còn ngoài dải sẽ tạo ra những chỉnh sửa tạm thời và sụp đổ dưới áp lực thi đấu.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ ĐIỂM VÀO CHẨN ĐOÁN - SỨC MẠNH HÃM LỆCH TÂM CHO BỘ PHÁP ĐA HƯỚNG        │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ ĐẦU VÀO A: Lực hãm tại bàn chân trụ = 3-4 x body mass               │
│ ├─ ĐẦU VÀO B: Độ dài bước áp chót = 60-75% of maximal stride           │
│ ├─ ĐẦU VÀO C: Thời gian đổi hướng = 2.30-2.55 s for 5-10-5             │
└────────────────────────────────────────────────────────────────────────┘

                    |
        ┌───────────┴────────────┐
        │ Lực hãm tại bàn chân trụ │
        └───┬────────────────┬───┘
       CÓ   │                │  KHÔNG
   ┌────────▼────────┐  ┌────▼─────────────┐
   │ tăng tải        │  │ giữ tải,         │
...
Hãy quan sát riêng khoảnh khắc **Lực hãm tại bàn chân trụ** lệch khỏi mức 3-4 x body mass - trong gần như mọi trường hợp, độ lệch xuất hiện trước khiếm khuyết kỹ thuật nhìn thấy được, chứ không phải sau đó.
...
- **Bài viết 172 - Phác Đồ Ấm Rotator Cuff Và Scapular Y-T-W**: đưa ra logic cửa sổ phục hồi quyết định khoảng cách giữa các khối tập này.
- **Bài viết 170 - Bù Nước, Tỷ Lệ Electrolyte Và Điều Hồi Nhiệt Độ Cốt Lõi**: định nghĩa dấu hiệu lực - thời gian mà mẫu này cuối cùng phụ thuộc vào.
...
- **Bài viết 169 - Chiến Lược Thải Lactate Qua Phục Hồi Aerobic Chủ Động**: chi tiết quy tắc tăng tiến tải giúp thích nghi này không bị đình trệ.
...
- **Bài viết 166 - Kiến Trúc Giấc Ngủ Và Điều Chỉnh Đỉnh Hormone Tăng Trưởng**: ghi nhận kiểu thất bại thường bị nhầm với lỗi kỹ thuật ở đây.
...
- **Bài viết 163 - Metabolic Work-to-Rest Ratio Optimization (1:3 vs. 1:5)**: định nghĩa dấu hiệu lực - thời gian mà mẫu này cuối cùng phụ thuộc vào.
...
Đọc cùng các bài này, sức mạnh hãm lệch tâm cho bộ pháp đa hướng trở thành một **nút trong hệ thống** thay vì một bài tập tách rời: ràng buộc cơ sinh học, tín hiệu tri giác, quy tắc tải và giá trị theo trạng thái tỷ số đều phải đúng đồng thời thì mẫu mới tồn tại được dưới áp lực thi đấu.
...
| --- | --- | --- | --- | --- |
| A - Chính | Đặt Chân Ngang Và Giữ | 4 x 8 | Tiếp cận, đặt chân, giữ 2 giây, rồi tăng tốc lại; 5 vị trí | 60 giây |
| B - Phụ | Tiếp Đất Một Chân Từ Độ Cao | 3 x 10 | Rơi từ 30-40 cm và giữ vững khi tiếp đất, 4 x 6 mỗi chân | 60 giây |
...
Quy tắc cấp buổi tập: không bao giờ kết thúc buổi tập khi **Lực hãm tại bàn chân trụ** nằm ngoài dải mục tiêu quá một bước tăng tiến; mẫu bạn lặp lại khi đang ngoài dải chính là mẫu bạn sẽ tái hiện dưới áp lực.
