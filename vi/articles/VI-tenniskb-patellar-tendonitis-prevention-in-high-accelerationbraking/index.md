---
title: "Bài viết 181: Patellar Tendonitis Prevention in High Acceleration/Braking"
description: "TennisKB - Bài viết 181: Patellar Tendonitis Prevention in High Acceleration/Braking | Tennis Future Lab"
author: "Henry Pham"
date: 2025-01-15
lang: vi
pillar: "the-luc"
...
article_number: 181
prev_article: "VI-tenniskb-plyometric-shock-training-for-explosive-ground-force-reactio"
next_article: "VI-tenniskb-adductor-strain-mitigation-in-extreme-open-stance-slides"
---

# Bài viết 181: Patellar Tendonitis Prevention in High Acceleration/Braking

> **CUE CHUYÊN GIA:** **phòng ngừa bệnh gân bánh chè trong tăng tốc và hãm tốc cao** = một **hợp đồng liều - đáp ứng** với phục hồi ở mẫu số - hãy huấn luyện đúng phẩm chất mà trận đấu thực sự đòi hỏi, ở mức tải mà mô có thể hấp thụ, và kiểm chứng bằng chỉ số thay vì bằng cảm giác.
...
<div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 8px; margin: 1.5rem 0;">
  <iframe src="https://www.youtube-nocookie.com/embed/VIDEO_ID_PLACEHOLDER" title="Patellar Tendonitis Prevention in High Acceleration/Braking" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
</div>

## 1. Tóm Tắt Điều Hành & Ý Đồ Thể Thao

Tải lên gân bánh chè là tích của **góc gập gối, xung lực hãm và số lần lặp lại**, và tennis trên sân cứng cung cấp cả ba ở mức cao. Do đó phòng ngừa phụ thuộc vào việc nâng ngưỡng chịu tải của gân thông qua nạp tải chậm và nặng thay vì chỉ giảm thời gian thi đấu.
...
Bài viết này thiết lập **khung phòng ngừa bệnh gân bánh chè trong tăng tốc và hãm tốc cao hoàn chỉnh**:

1. **Các Yếu Tố Quyết Định Tải Ở Gân Bánh Chè** - Lực gân tăng dốc khi gối gập quá 60 độ và khi xung lực hãm tăng.
2. **Kháng Lực Chậm Nặng & Lộ Trình Của Nó** - Kháng lực chậm nặng ở 3-4 giây mỗi lần lặp tạo ra cả tải cơ học lẫn hiệu ứng giảm đau, với cải thiện đo được về đau và chức năng trong 12 tuần.
...
- Thứ nhất, chuyển **phòng ngừa bệnh gân bánh chè trong tăng tốc và hãm tốc cao** từ một hành vi dựa trên trực giác và cảm xúc thành một **phác đồ lặp lại được**, với đầu vào được tuyên bố, đầu ra đo lường được, và kiểu thất bại được định nghĩa.
- Thứ hai, làm cho **các yếu tố giới hạn trở nên tường minh**. Những biến thực sự giới hạn hiệu suất ở đây là Tải bài squat dốc, Ngưỡng đau và Tải nhảy mỗi tuần; mọi thứ khác chỉ là thứ yếu cho tới khi ba biến này được kiểm soát.
...
### 2.1 Các Yếu Tố Quyết Định Tải Ở Gân Bánh Chè
...
- **Tải bài squat dốc** đo ở mức **progressive to 1.2-1.6 x body mass** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Ngưỡng đau** đo ở mức **3/10 during loading** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Tải nhảy mỗi tuần** đo ở mức **cap at 140-180 contacts** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
...
### 2.2 Kháng Lực Chậm Nặng & Lộ Trình Của Nó
...
- Dải mục tiêu cho **Tải bài squat dốc**: progressive to 1.2-1.6 x body mass trong điều kiện kiểm soát, suy giảm một mức đo được khi mệt.
- Dải mục tiêu cho **Ngưỡng đau**: 3/10 during loading, kiểm chứng ít nhất hai lần mỗi trung chu kỳ.
- Dải mục tiêu cho **Tải nhảy mỗi tuần**: cap at 140-180 contacts, theo dõi bằng cùng một phác đồ mỗi lần.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ MÔ HÌNH ĐỊNH LƯỢNG - PHÒNG NGỪA BỆNH GÂN BÁNH CHÈ TRONG TĂNG TỐC VÀ    │
│ HÃM TỐC CAO                                                            │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ 1. Tải bài squat dốc = progressive to 1.2-1.6 x body mass (đầu vào  │
│ │  kiểm soát được chính)                                               │
│ ├─ 2. Ngưỡng đau = 3/10 during loading (biến chuyển giao thứ cấp)      │
│ ├─ 3. Tải nhảy mỗi tuần = cap at 140-180 contacts (dấu hiệu kiểm chứng) │
...
1. **Thiết Lập Nền Đau** - Ghi lại mức đau khi chơi, sau khi chơi, và sáng hôm sau trước khi bắt đầu bất kỳ chương trình nạp tải nào.
2. **Nạp Tải Với Nhịp Chậm, Không Khối Lượng Lớn** - Dùng nhịp 3-4 giây ở tải vừa thay vì số lần lặp cao; nhịp quyết định kích thích cơ học.
...
| --- | --- | --- | --- |
| Tải bài squat dốc | Đo trực tiếp, cùng phác đồ mỗi lần | progressive to 1.2-1.6 x body mass | progressive to 1.2-1.6 x body mass duy trì được khi mệt |
| Ngưỡng đau | Đo trực tiếp, cùng phác đồ mỗi lần | 3/10 during loading | 3/10 during loading duy trì được khi mệt |
| Tải nhảy mỗi tuần | Đo trực tiếp, cùng phác đồ mỗi lần | cap at 140-180 contacts | cap at 140-180 contacts duy trì được khi mệt |
...
Thứ tự ưu tiên khắc phục: trước hết đưa **Tải bài squat dốc** về dải mục tiêu, sau đó kiểm chứng lại **Ngưỡng đau**; chỉ khi đó mới tăng tải. Cố sửa lỗi thực thi trong khi năng lực nền còn ngoài dải sẽ tạo ra những chỉnh sửa tạm thời và sụp đổ dưới áp lực thi đấu.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ ĐIỂM VÀO CHẨN ĐOÁN - PHÒNG NGỪA BỆNH GÂN BÁNH CHÈ TRONG TĂNG TỐC VÀ    │
│ HÃM TỐC CAO                                                            │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ ĐẦU VÀO A: Tải bài squat dốc = progressive to 1.2-1.6 x body mass   │
│ ├─ ĐẦU VÀO B: Ngưỡng đau = 3/10 during loading                         │
│ ├─ ĐẦU VÀO C: Tải nhảy mỗi tuần = cap at 140-180 contacts              │
└────────────────────────────────────────────────────────────────────────┘

                    |
        ┌───────────┴────────────┐
        │ Tải bài squat dốc trong  │
        └───┬────────────────┬───┘
       CÓ   │                │  KHÔNG
   ┌────────▼────────┐  ┌────▼─────────────┐
   │ tăng tải        │  │ giữ tải,         │
...
Hãy quan sát riêng khoảnh khắc **Tải bài squat dốc** lệch khỏi mức progressive to 1.2-1.6 x body mass - trong gần như mọi trường hợp, độ lệch xuất hiện trước khiếm khuyết kỹ thuật nhìn thấy được, chứ không phải sau đó.
...
- **Bài viết 182 - Giảm Thiểu Chấn Thương Cơ Thêm Cực Đoạn Trong Trượt Cởi Mở**: trình bày tín hiệu tri giác giúp rút ngắn độ trễ nhận diện trong tình huống này.
- **Bài viết 180 - Plyometric Shock Training for Explosive Ground Force Reaction**: chi tiết quy tắc tăng tiến tải giúp thích nghi này không bị đình trệ.
...
- **Bài viết 179 - Foot Structure Rigidity & Plantar Fascia Health in Hard-Court Play**: thiết lập ràng buộc giải phẫu giới hạn khối lượng có thể nạp cho mẫu này trong một buổi tập.
...
- **Bài viết 186 - Phác Đồ Xả Chất Thải Chuyển Hóa Sau Trận**: đưa ra logic cửa sổ phục hồi quyết định khoảng cách giữa các khối tập này.
- **Bài viết 176 - Điều Chỉnh Nhịp Sinh Học Cho Giải Đấu Quốc Tế**: định nghĩa dấu hiệu lực - thời gian mà mẫu này cuối cùng phụ thuộc vào.
...
Đọc cùng các bài này, phòng ngừa bệnh gân bánh chè trong tăng tốc và hãm tốc cao trở thành một **nút trong hệ thống** thay vì một bài tập tách rời: ràng buộc cơ sinh học, tín hiệu tri giác, quy tắc tải và giá trị theo trạng thái tỷ số đều phải đúng đồng thời thì mẫu mới tồn tại được dưới áp lực thi đấu.
...
| --- | --- | --- | --- | --- |
| A - Chính | Squat Dốc Nhịp Chậm | 4 x 8 | 3 x 15 với 3 giây xuống và 3 giây lên, tải tăng mỗi tuần | 60 giây |
| B - Phụ | Ngồi Tựa Tường Đẳng Trường | 3 x 10 | 5 x 45 giây ở 70% nỗ lực để giảm đau trước khi thi đấu | 60 giây |
...
Quy tắc cấp buổi tập: không bao giờ kết thúc buổi tập khi **Tải bài squat dốc** nằm ngoài dải mục tiêu quá một bước tăng tiến; mẫu bạn lặp lại khi đang ngoài dải chính là mẫu bạn sẽ tái hiện dưới áp lực.
