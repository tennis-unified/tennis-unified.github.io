---
title: "Bài viết 198: Chẩn Đoán Sức Mạnh Triple-Extension Chi Dưới"
description: "TennisKB - Bài viết 198: Chẩn Đoán Sức Mạnh Triple-Extension Chi Dưới | Tennis Future Lab"
author: "Henry Pham"
date: 2025-01-15
lang: vi
pillar: "the-luc"
...
article_number: 198
prev_article: "VI-tenniskb-shoulder-internal-rotation-deficit-gird-counter-measures"
next_article: "VI-tenniskb-central-nervous-system-cns-fatigue-monitoring-systems"
---

# Bài viết 198: Chẩn Đoán Sức Mạnh Triple-Extension Chi Dưới

> **CUE CHUYÊN GIA:** **chẩn đoán sức mạnh duỗi ba khớp chi dưới** = một **hợp đồng liều - đáp ứng** với phục hồi ở mẫu số - hãy huấn luyện đúng phẩm chất mà trận đấu thực sự đòi hỏi, ở mức tải mà mô có thể hấp thụ, và kiểm chứng bằng chỉ số thay vì bằng cảm giác.
...
<div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 8px; margin: 1.5rem 0;">
  <iframe src="https://www.youtube-nocookie.com/embed/VIDEO_ID_PLACEHOLDER" title="Chẩn Đoán Sức Mạnh Triple-Extension Chi Dưới" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
</div>

## 1. Tóm Tắt Điều Hành & Ý Đồ Thể Thao

Duỗi ba khớp - hông, gối và cổ chân cùng duỗi - là **sự kiện công suất cuối cùng** của động tác giao bóng, động tác trên cao, và bước đầu tiên sau bước tách. Chẩn đoán nó đòi hỏi tách riêng ba khớp, vì sự thiếu hụt ở một khớp tạo ra kiểu bù trừ đặc trưng không thể sửa bằng cách huấn luyện hai khớp còn lại.
...
Bài viết này thiết lập **khung chẩn đoán sức mạnh duỗi ba khớp chi dưới hoàn chỉnh**:

1. **Đóng Góp Và Trình Tự Theo Từng Khớp** - Duỗi ba khớp hiệu quả diễn ra theo trình tự từ gốc tới ngọn: hông duỗi trước, rồi gối, rồi cổ chân, với cổ chân đóng góp 20-30% cuối cùng của vận tốc thẳng đứng.
2. **Bộ Bài Chẩn Đoán** - Bộ bài gồm nhảy có bước đà, nhảy từ tư thế squat để tách riêng đóng góp đồng tâm, nhảy dọc một chân, và một bài phản ứng riêng cho cổ chân.
...
- Thứ nhất, chuyển **chẩn đoán sức mạnh duỗi ba khớp chi dưới** từ một hành vi dựa trên trực giác và cảm xúc thành một **phác đồ lặp lại được**, với đầu vào được tuyên bố, đầu ra đo lường được, và kiểu thất bại được định nghĩa.
- Thứ hai, làm cho **các yếu tố giới hạn trở nên tường minh**. Những biến thực sự giới hạn hiệu suất ở đây là Độ cao nhảy có bước đà, Công suất gập mu cổ chân và Thời gian trình tự duỗi ba khớp; mọi thứ khác chỉ là thứ yếu cho tới khi ba biến này được kiểm soát.
...
### 2.1 Đóng Góp Và Trình Tự Theo Từng Khớp
...
- **Độ cao nhảy có bước đà** đo ở mức **45-60 cm** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Công suất gập mu cổ chân** đo ở mức **over 25 W/kg** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
- **Thời gian trình tự duỗi ba khớp** đo ở mức **under 0.35 s** là biểu hiện vận hành của nguyên lý này trong mô hình hiện tại.
...
- Dải mục tiêu cho **Độ cao nhảy có bước đà**: 45-60 cm trong điều kiện kiểm soát, suy giảm một mức đo được khi mệt.
- Dải mục tiêu cho **Công suất gập mu cổ chân**: over 25 W/kg, kiểm chứng ít nhất hai lần mỗi trung chu kỳ.
- Dải mục tiêu cho **Thời gian trình tự duỗi ba khớp**: under 0.35 s, theo dõi bằng cùng một phác đồ mỗi lần.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ MÔ HÌNH ĐỊNH LƯỢNG - CHẨN ĐOÁN SỨC MẠNH DUỖI BA KHỚP CHI DƯỚI          │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ 1. Độ cao nhảy có bước đà = 45-60 cm (đầu vào kiểm soát được chính) │
│ ├─ 2. Công suất gập mu cổ chân = over 25 W/kg (biến chuyển giao thứ    │
│ │  cấp)                                                                │
│ ├─ 3. Thời gian trình tự duỗi ba khớp = under 0.35 s (dấu hiệu kiểm    │
│ │  chứng)                                                              │
...
1. **Tách Đóng Góp Đàn Hồi Khỏi Đồng Tâm** - So sánh nhảy có bước đà với nhảy từ tư thế squat; chênh lệch nhỏ cho thấy việc sử dụng đàn hồi kém chứ không phải cơ yếu.
2. **Kiểm Tra Cả Một Bên Lẫn Hai Bên** - Nhảy hai bên có thể che giấu thiếu hụt một chân đáng kể; cần cả hai phép đo để chẩn đoán.
...
| --- | --- | --- | --- |
| Độ cao nhảy có bước đà | Đo trực tiếp, cùng phác đồ mỗi lần | 45-60 cm | 45-60 cm duy trì được khi mệt |
| Công suất gập mu cổ chân | Đo trực tiếp, cùng phác đồ mỗi lần | over 25 W/kg | over 25 W/kg duy trì được khi mệt |
| Thời gian trình tự duỗi ba khớp | Đo trực tiếp, cùng phác đồ mỗi lần | under 0.35 s | under 0.35 s duy trì được khi mệt |
...
Thứ tự ưu tiên khắc phục: trước hết đưa **Độ cao nhảy có bước đà** về dải mục tiêu, sau đó kiểm chứng lại **Công suất gập mu cổ chân**; chỉ khi đó mới tăng tải. Cố sửa lỗi thực thi trong khi năng lực nền còn ngoài dải sẽ tạo ra những chỉnh sửa tạm thời và sụp đổ dưới áp lực thi đấu.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│ ĐIỂM VÀO CHẨN ĐOÁN - CHẨN ĐOÁN SỨC MẠNH DUỖI BA KHỚP CHI DƯỚI          │
├────────────────────────────────────────────────────────────────────────┤
│ ├─ ĐẦU VÀO A: Độ cao nhảy có bước đà = 45-60 cm                        │
│ ├─ ĐẦU VÀO B: Công suất gập mu cổ chân = over 25 W/kg                  │
│ ├─ ĐẦU VÀO C: Thời gian trình tự duỗi ba khớp = under 0.35 s           │
└────────────────────────────────────────────────────────────────────────┘

                    |
        ┌───────────┴────────────┐
        │ Độ cao nhảy có bước đà   │
        └───┬────────────────┬───┘
       CÓ   │                │  KHÔNG
   ┌────────▼────────┐  ┌────▼─────────────┐
   │ tăng tải        │  │ giữ tải,         │
...
Hãy quan sát riêng khoảnh khắc **Độ cao nhảy có bước đà** lệch khỏi mức 45-60 cm - trong gần như mọi trường hợp, độ lệch xuất hiện trước khiếm khuyết kỹ thuật nhìn thấy được, chứ không phải sau đó.
...
- **Bài viết 199 - Hệ Thống Theo Dõi Mệt Mỏi Hệ Thần Kinh Trung Ương (CNS)**: chi tiết quy tắc tăng tiến tải giúp thích nghi này không bị đình trệ.
- **Bài viết 197 - Phòng Chống Thiếu Hụt Xoay Trong Vai (GIRD)**: giải thích bối cảnh trạng thái tỷ số làm thay đổi giá trị của mẫu này.
...
- **Bài viết 196 - Chẩn Đoán & Phác Đồ Khắc Phục Bất Đối Xứng Hai Bên**: cung cấp phác đồ đo lường dùng để kiểm chứng các mục tiêu ở Mục 4.
- **Bài viết 195 - Huấn Luyện Sức Mạnh Micro-Dose Trong Lịch Thi Đấu Dày Đặc**: ghi nhận kiểu thất bại thường bị nhầm với lỗi kỹ thuật ở đây.
- **Bài viết 193 - Phác Đồ Dẫn Dắt Trạng Thái Flow Satori**: đưa ra logic cửa sổ phục hồi quyết định khoảng cách giữa các khối tập này.
- **Bài viết 190 - Phác Đồ Thích Nghi Nóng Cho Giải Đấu Mùa Hè**: định nghĩa dấu hiệu lực - thời gian mà mẫu này cuối cùng phụ thuộc vào.
...
Đọc cùng các bài này, chẩn đoán sức mạnh duỗi ba khớp chi dưới trở thành một **nút trong hệ thống** thay vì một bài tập tách rời: ràng buộc cơ sinh học, tín hiệu tri giác, quy tắc tải và giá trị theo trạng thái tỷ số đều phải đúng đồng thời thì mẫu mới tồn tại được dưới áp lực thi đấu.
...
| --- | --- | --- | --- | --- |
| A - Chính | Cặp Nhảy Có Bước Đà Và Nhảy Squat | 4 x 8 | 3 lần thử mỗi bài, ghi lại độ cao nhảy | 60 giây |
| B - Phụ | Chuỗi Phản Ứng Cổ Chân | 3 x 10 | Chuỗi nhảy pogo và nhảy cổ chân, 3 x 15 lần tiếp đất | 60 giây |
...
Quy tắc cấp buổi tập: không bao giờ kết thúc buổi tập khi **Độ cao nhảy có bước đà** nằm ngoài dải mục tiêu quá một bước tăng tiến; mẫu bạn lặp lại khi đang ngoài dải chính là mẫu bạn sẽ tái hiện dưới áp lực.
